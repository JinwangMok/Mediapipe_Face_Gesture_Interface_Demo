...
from gesture_info_per_frame import Gesture_info_per_frame
...
if __name__ == "__main__":
    ...
    with face_mesh:
        ...
        while cap.isOpened():
            ...
            cv2.putText(image, f"rolling_angle: {face_angle_stabilizer.mean_of_angles['rolling']}", (10, 90), cv2.FONT_HERSHEY_SIMPLEX, 1., (0, 255, 0), 3, cv2.LINE_AA)
            cv2.putText(image, f"tilting_angle: {face_angle_stabilizer.mean_of_angles['tilting']}", (10, 120), cv2.FONT_HERSHEY_SIMPLEX, 1., (0, 255, 0), 3, cv2.LINE_AA)
            cv2.putText(image, f"panning_angle: {face_angle_stabilizer.mean_of_angles['panning']}", (10, 150), cv2.FONT_HERSHEY_SIMPLEX, 1., (0, 255, 0), 3, cv2.LINE_AA)
            ...
            cv2.putText(image, f"rolling_angle: {face_info_per_frame.rolling_angle}", (10, 210), cv2.FONT_HERSHEY_SIMPLEX, 1., (0, 255, 0), 3, cv2.LINE_AA)
            cv2.putText(image, f"tilting_angle: {face_info_per_frame.tilting_angle}", (10, 240), cv2.FONT_HERSHEY_SIMPLEX, 1., (0, 255, 0), 3, cv2.LINE_AA)
            cv2.putText(image, f"panning_angle: {face_info_per_frame.panning_angle}", (10, 270), cv2.FONT_HERSHEY_SIMPLEX, 1., (0, 255, 0), 3, cv2.LINE_AA)
